...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      // Special route for SSO authentication iframe
      {
        source: '/auth/sso/(.*)',
        headers: [
          {
          ...
          },
          {
            ...
            value: "frame-ancestors 'self' https://vikareta.com https://*.vikareta.com;",
          },
        ],
      },
      // Root page - allow iframe for cross-domain auth
      {
        source: '/',
        headers: [
          {
